unit fpcorm_codebuilder_types;

{< @abstract(This unit contains the objects that are enabling and easing the
     writing of source code from within a program.)
   @author(Andreas Lorenzen - aplorenzen@gmail.com)
   @created(2013-12-16)

   The classes in this unit, enable the user (programmer) of creating an object
     structure og sourcecode elements, and the asking the structure to write
     itself somwhere. The TcbUnit object, can write itself to a TStringList.

   It does have a lot of limitations, that can be fixed though:
     * Generics are not possible currently
     * Not the full type withing type structure is offered
     * Not all blocks are offered within functions
